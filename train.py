...
parser.add_argument('--snapshot-folder', type=str, default='./snapshots/capsnetMNIST-2', metavar='SF',
...
#     A, B, C, D = 64, 8, 16, 16
    ...
    criterion = CapsuleLoss(alpha=args.alpha, mode='spread', add_decoder=args.add_decoder)
